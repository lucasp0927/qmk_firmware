...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  RGUI(KC_SPC), _______, _______, _______, KC_HOME,  KC_END,                      KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, _______,  KC_F12,
  //  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,S(KC_NUHS),S(KC_NUBS),KC_HOME, KC_END, _______,
  LGUI(KC_LSFT),   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                        KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,
  //  _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
  KC_LALT, KC_LCTL, KC_LGUI, KC_LSFT, _______,   KC_SPC,  KC_ENT,  _______,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  RGUI(KC_SPC), _______, _______, _______, _______, _______,                      KC_MINS,  KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS,  KC_GRV,
  LGUI(KC_LSFT), _______, _______, _______, _______, _______,                      KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_TILD,
  KC_LALT, KC_LCTL, KC_LGUI, KC_LSFT, _______,   KC_SPC,  KC_ENT,  _______,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, RGB_MOD, KC_PSCR,              KC_KB_VOLUME_UP,    KC_4,    KC_5,    KC_6,  KC_DOT, _______,
  EEP_RST, RGB_HUD, RGB_SAD, RGB_VAD,RGB_RMOD, LCG_NRM,            KC_KB_VOLUME_DOWN,    KC_1,    KC_2,    KC_3,    KC_0, _______,
  KC_LALT, KC_LCTL, KC_LGUI, KC_LSFT, _______,  KC_SPC,  KC_ENT,  _______,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
